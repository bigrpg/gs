...
public:
	...
	void Ortho(float width,float height,float zn,float zf);
	void PerspectiveFov(float fov,float ratioHW,float zn,float zf);
	void Perspective(float width,float height,float zn,float zf);
